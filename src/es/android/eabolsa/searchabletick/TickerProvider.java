...
/**
 * Provides access to the dictionary tickers database.
 */
public class TickerProvider extends ContentProvider {
    String TAG = "TickerProvider";

    public static String AUTHORITY = "es.android.eabolsa.searchabletick.TickerProvider";
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/dictionary");

    // MIME types used for searching words or looking up a single definition
    public static final String WORDS_MIME_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE +
                                                  "/vnd.es.android.eabolsa.searchabletick";
    public static final String DEFINITION_MIME_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE +
                                                       "/vnd.es.android.eabolsa.searchabletick";

    private TickerDatabase mDictionary;
    ...
    public boolean onCreate() {
        mDictionary = new TickerDatabase(getContext());
        return true;
    }
